...
write.table(results,paste0('R_jackknife_',suffix,'.csv'), sep=',',col.names = TRUE, row.names = FALSE)
...
write.table(boot.final,paste0('R_jackknife_stats_',suffix,'.csv'), sep=',',col.names = TRUE, row.names = FALSE)
